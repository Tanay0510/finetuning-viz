...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///llmviz.db'
...
METHODS = [
    ...
    },
    {
        ...
        "stats": {"params": "~0.1-2%", "vram_7b": "~16GB", "vram_70b": "~80GB", "checkpoint": "15-60MB", "speed": "Moderate"},
    ...
    },
    {
        ...
        "stats": {"params": "100%", "vram_7b": "~22GB", "vram_70b": "~180GB", "checkpoint": "Full model", "speed": "Moderate"},
...
DEEP_DIVES = {
    "full": { "sections": [{"title": "How It Works", "content": "Full fine-tuning updates every parameter via standard backpropagation."}], "benchmarks": [], "tips": [] },
    "lora": { "sections": [{"title": "Low-Rank Adaptation", "content": "Freezes base weights, trains tiny A & B matrices."}], "benchmarks": [], "tips": [] },
    "qlora": { "sections": [{"title": "Quantized LoRA", "content": "NF4 quantization + LoRA adapters."}], "benchmarks": [], "tips": [] },
    "dora": { "sections": [{"title": "Weight Decomposition", "content": "Separates magnitude and direction of weights."}], "benchmarks": [], "tips": [] },
    "galore": { "sections": [{"title": "Gradient Projection", "content": "Projects gradients into low-rank space."}], "benchmarks": [], "tips": [] },
    "prefix": { "sections": [{"title": "Prefix Tuning", "content": "Learns virtual tokens at every layer."}], "benchmarks": [], "tips": [] },
    "adapters": { "sections": [{"title": "Adapter Layers", "content": "Inserts bottleneck modules between layers."}], "benchmarks": [], "tips": [] },
    "rlhf": { "sections": [{"title": "DPO Alignment", "content": "Aligns model with human preference pairs."}], "benchmarks": [], "tips": [] },
}
